...
<body>
            ...
            <div class="col g-0">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div>
                            <a class="btn AddButton d-flex flex-nowrap" href="addskillpage"><i class="bi bi-plus"></i>
                                <span>Add</span></a>
                        </div>
                    </div>
    ...
    function printDataintoRow(){
    	...
    	for(var a in incomingData){ 
    		skill=incomingData[a];
    		activeTag='';
    		if(skill.status=='ACTIVE'){
    			activeTag=`<p class="activeStatus">`+skill.status+`</p>`;
    		}
    		else{
    			activeTag=`<p class="deActiveStatus">`+skill.status+`</p>`;
    		}
    		let imgTags=`<a href="editskill?skill_id=`+skill.skillId+`"><img src="<c:url value="/image/editing.png"></c:url>" alt="" srcset=""></a>
    		<a><img src="<c:url value="/image/delete.png"></c:url>" id="`+skill.skillId+`" alt="" srcset="" class="delteThisRow"></a>`;
    	t.row.add( [
    		skill.skillName,
    		activeTag,
    		imgTags
