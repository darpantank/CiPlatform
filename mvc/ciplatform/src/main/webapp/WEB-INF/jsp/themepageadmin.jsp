...
<body>
            ...
            <div class="col g-0">
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div>
                            <a class="btn AddButton d-flex flex-nowrap" href="addthemepage"><i class="bi bi-plus"></i>
                                <span>Add</span></a>
                        </div>
                    </div>
    ...
    function printDataintoRow(){
    	...
    	for(var a in incomingData){ 
    		theme=incomingData[a];
    		activeTag='';
    		if(theme.status=='ACTIVE'){
    			activeTag=`<p class="activeStatus">`+theme.status+`</p>`;
    		}
    		else{
    			activeTag=`<p class="deActiveStatus">`+theme.status+`</p>`;
    		}
    		let imgTags=`<a href="edittheme?themeId=`+theme.themeId+`"><img src="<c:url value="/image/editing.png"></c:url>" alt="" srcset=""></a>
    		<a><img src="<c:url value="/image/delete.png"></c:url>" id="`+theme.themeId+`" alt="" srcset="" class="delteThisRow"></a>`;
    	t.row.add( [
    		theme.title,
    		activeTag,
    		imgTags
