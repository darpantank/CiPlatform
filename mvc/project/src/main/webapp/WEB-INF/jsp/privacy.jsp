...
<body>
    ...
    <div class="container headingTagDiv">
        <p class="headingOfPAge">Privacy and Cookies Policy</p>
    </div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-3 d-flex flex-column">
                <div id="list-example" class="list-group listItemTab">
                    <button class=" btn list-group-item list-group-item-action activeComponent">
                        <a href="#list-item-1">Introduction</a>
                        <img src="image/right-arrow1.png" alt="" srcset="">
                    </button>
                    <button class=" btn list-group-item list-group-item-action">

                        <a href="#list-item-2">How does use cookies?</a>
                        <img src="image/right-arrow1.png" alt="" srcset="">
                    </button>
                    <button class=" btn list-group-item list-group-item-action">
                        <a href="#list-item-3">How to manage your cookie preferences?</a>
                        <img src="image/right-arrow1.png" alt="" srcset="">
                    </button>
                </div>
            ...
            <div class="col-xs-12 col-sm-9">
                ...
                <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
                    <p class="listItemTitle" id="list-item-1">Introduction</p>
                    <p>
                        ...
                        consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Lorem ipsum dolor sit
                    ...
                    <p class="listItemTitle" id="list-item-2">How does use cookies?</p>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                        ...
                        <br><br>
                        <b class="subTitleGroupText">Why Optimy Use This Technologies ?</b>
                        <br><br>
                    ...
                    <ul>
                        ...
                        <li> At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                            voluptatum deleniti atque excepturi sint occaecati cupiditate non provident, similique sunt
                            in culpa qui officia deserunt mollitia animi.</li>
                        <li> On the other hand, we denounce with righteous indignation and dislike men who are so
                            beguiled and demoralized </li>
                        <li>But I must explain to you how all this mistaken idea of denouncing pleasure and praising
                            pain. </li>
                    ...
                    <p class="listItemTitle" id="list-item-3">How to manage your cookie preferences ?</p>
                    <P>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                    ...
                    <h4>
                        forth level heading - H4
                    </h4>
                    <h5>
                        The fifth level heading - H5
                    </h5>
                    <h6>
                        The sixth level heading - H6
                    </h6>
                    <br>
    ...
    <div class="contaainer-fluid g-0 footer mt-4">
        <div class="container">
